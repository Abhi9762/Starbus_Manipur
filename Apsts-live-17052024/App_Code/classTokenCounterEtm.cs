...
/// <summary>
/// Summary description for classTokenCounterEtm
/// </summary>
public class classTokenCounterEtm
{
    private string uID; // field
    public string uIMEI;
    public string uAuthenticationToken;
    public classTokenCounterEtm()
    {
    ...
    public bool IsUserCredentialsValid(classTokenCounterEtm SoapHeader)
    {
        if (SoapHeader == null)
            return false;
