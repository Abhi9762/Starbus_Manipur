...
public partial class Auth_changepassfirsttime : System.Web.UI.Page
{
    ...
    {
        loaddata();
        if (Session["_Passwdstatus"].ToString() == "F")
        {
            lblusermsg.Text = "To ensure your account's security, <br/>please take a moment to update your password before continuing.";
        }
        if (Session["_Passwdstatus"].ToString() == "E")
        {
            lblusermsg.Text = " Your password has expired. For your account’s security, <br/>please update your password before proceeding.";
        }
