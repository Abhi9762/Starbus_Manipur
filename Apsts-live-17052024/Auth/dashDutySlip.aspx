<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dashDutySlip.aspx.cs" Inherits="Auth_dashDutySlip" %>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-7">
                                                                    <h5>
                                                                        ...
                                                                        Duty Date/Time:
																	<asp:Label runat="server" ID="Label3" CssClass="text-sm ml-1 form-control-label font-weight-600 mr-5"><%# Eval("dutydatetime") %></asp:Label>
                                                                ...
                                                                <div class="col-lg-2">
                                                                    <h5>Driver:
																<asp:Label runat="server" ID="lblDriver1" CssClass="form-control-label  text-sm"><%# Eval("DRIVER1NAME") %></asp:Label>
                                                                       
                                                                        <asp:Label runat="server" ID="lblDriver2" Visible="false" CssClass="form-control-label text-sm"><%# Eval("DRIVER2NAME") %></asp:Label>
                                                                    <br />Conductor:
																<asp:Label runat="server" ID="lblConductor1" CssClass="form-control-label text-sm"><%# Eval("CONDUCTOR1NAME") %></asp:Label><br />
                                                                        <asp:Label runat="server" ID="lblConductor2" Visible="false" CssClass="form-control-label  text-sm"><%# Eval("CONDUCTOR2NAME") %></asp:Label></h5>
                                                                </div>
