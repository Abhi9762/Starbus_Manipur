<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/AgentMaster.master" AutoEventWireup="true" CodeFile="AgConfirm.aspx.cs" Inherits="Auth_AgConfirm" %>
                ...
                <div class="card" style="width: 350px;">
                    ...
                    <div class="card-body text-center pt-2" style="min-height: 100px;">
                        ...
                        <div style="width: 100%; margin-top: 20px; text-align: right;">
                            ...
                            <asp:LinkButton ID="lbtnNoConfirmation" OnClientClick="return ShowLoading();" runat="server" CssClass="btn btn-danger btn-sm ml-2"> <i class="fa fa-times"></i> No </asp:LinkButton>
                        </div>
                    </div>
                </div>
