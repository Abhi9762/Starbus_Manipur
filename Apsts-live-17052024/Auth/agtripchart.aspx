<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/AgentMaster.master" AutoEventWireup="true" CodeFile="agtripchart.aspx.cs" Inherits="Auth_agtripchart" %>
        ...
        <div class="card-header">
            <div class="row">
                <div class="col-12 input-group-prepend">
                    ...
                    <asp:DropDownList ID="ddlstation" runat="server" Style="height: 30px; font-size: 9pt;"
                        ToolTip="Station Name" Width="150px" AutoPostBack="false" class="form-control ml-2 mr-4">
                    </asp:DropDownList>
                    <span>Date
                    </span>
