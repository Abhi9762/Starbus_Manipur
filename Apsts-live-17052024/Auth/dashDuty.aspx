<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dashDuty.aspx.cs" Inherits="Auth_dashDuty" %>
                            ...
                            <asp:Panel runat="server" ID="pnlViewDuty" Visible="true">
                                <div>
                                    <asp:GridView ID="gvAllotedDuties" runat="server" AutoGenerateColumns="false" GridLines="None" ShowHeader="false"
                                        AllowPaging="false" OnRowDataBound="gvAllotedDuties_RowDataBound" OnRowCommand="gvAllotedDuties_RowCommand" CssClass="table table-hover" DataKeyNames="dutyrefno">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Service">
                                                <ItemTemplate>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-11">
                                                            <h5>
                                                                <asp:Label runat="server" ID="Label2" CssClass="form-control-label font-weight-600"><%# Eval("service_name_en") %></asp:Label><br />
                                                                Duty Date/Time:
																	<asp:Label runat="server" ID="Label3" CssClass="form-control-label font-weight-600 mr-3"><%# Eval("departuretime") %></asp:Label>
                                                                Bus:
																<asp:Label runat="server" ID="lblBusNo" CssClass="form-control-label text-sm mr-3"><%# Eval("busno") %></asp:Label>
                                                                Driver:
																<asp:Label runat="server" ID="Label4" Style="white-space: normal" CssClass="form-control-label  text-sm  mr-3"><%# Eval("empdriver1") %></asp:Label>
                                                                Conductor:
                                                               <asp:Label runat="server" ID="lblConductor1" CssClass="form-control-label text-sm mr-3"><%# Eval("empconductor1") %></asp:Label>
                                                            </h5>
                                                        </div>
                                                        <div class="col-lg-1">
