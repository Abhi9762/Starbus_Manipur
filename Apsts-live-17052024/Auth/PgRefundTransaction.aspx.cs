...
public partial class Auth_PgRefundTransaction : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            txtrefunddate.Text = DateTime.Now.AddDays(-1).ToString("dd") + "/"+ DateTime.Now.AddDays(-1).ToString("MM") +"/"+ DateTime.Now.AddDays(-1).ToString("yyyy");
