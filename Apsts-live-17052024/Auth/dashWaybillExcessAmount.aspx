<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dashWaybillExcessAmount.aspx.cs" Inherits="Auth_dashWaybillExcessAmount" %>
                        ...
                        <asp:Panel runat="server" ID="pnldata" Visible="false">
                            <div class="row">
                                ...
                                <div class="col-6 pl-3">
                                    <div class="row">
                                        <div class="col-lg-12 text-center">
                                            <h2 style="font-size: 13pt" class="text-center">Submit Excess Amount Information</h2>
                                        </div>
                                        <div class="col-sm-12 mb-2">
                                            <asp:Label runat="server" ID="Label1" Style="color: #767373; font-size: 15px" Text="Remark ">Enter Excess Amount Txn Details<span class="text-warning">*</span></asp:Label>
                                        </div>
                                        <div class="col-sm-12 mb-2">
                                            <asp:GridView ID="gvTxnDetails" Visible="true" OnRowCommand="gvTxnDetails_RowCommand"
                                                HeaderStyle-CssClass="thead-light font-weight-bold" GridLines="None" runat="server"
                                                CssClass="table table-striped table-hover" AutoGenerateColumns="false" DataKeyNames=""
                                                OnRowDataBound="gvTxnDetails_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-Font-Size="Small" HeaderText="Ticket No.">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="tbtxn" placeholder="Ticket No." AutoComplete="off" MaxLength="20"
                                                                CssClass="form-control form-control-sm" runat="server"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField HeaderStyle-Font-Size="Small" HeaderText="Actual Amount">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="tbactulamt" placeholder="Actual ₹" AutoComplete="off" MaxLength="8"
                                                                CssClass="form-control form-control-sm" runat="server"></asp:TextBox>
                                                            <cc1:FilteredTextBoxExtender ID="ajaxFTtbtokm1" ValidChars="1234567890." runat="server" FilterType="Custom" TargetControlID="tbactulamt" />

                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-Font-Size="Small" HeaderText="Excess Amount">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="tbexcessamt" placeholder="Excess ₹" AutoComplete="off" MaxLength="8"
                                                                CssClass="form-control form-control-sm" runat="server"></asp:TextBox>
                                                            <cc1:FilteredTextBoxExtender ID="ajaxFTtbAccedentSCSlab1" ValidChars="1234567890." runat="server" FilterType="Custom" TargetControlID="tbexcessamt" />
                                            ...
                                            <label class="text-danger text-xs">Last Row will not be saved. Please leave it blank.</label>

                                        </div>

                                        <div class="col-sm-5 mb-2" runat="server" id="dvfile" visible="true">
                                            <asp:Label runat="server" ID="Label11" Style="color: #767373; font-size: 15px" Text="Upload Signed File ">Upload Signed Image<span class="text-danger" style="font-size:12px">*(Max 2 MB jpg, jpeg Only)</span></asp:Label>
                                        </div>
                                        <div class="col-sm-5 mb-2" runat="server" id="dvfileupload" visible="true">
                                        ...
                                        <div class="col-sm-5 mb-2">
                                            <asp:Label runat="server" ID="Label10" Style="color: #767373; font-size: 15px" Text="Remark ">Remark<span class="text-danger">*</span></asp:Label>
                                        </div>
                                        <div class="col-sm-7 mb-2">
                                            <asp:TextBox runat="server" CssClass="form-control" ID="txtremark" placeholder="Enter Remark" MaxLength="200"></asp:TextBox>
                                        </div>
                                        <div class="col-sm-12 mb-2">
                                            <asp:LinkButton runat="server" OnClick="btnsubmit_Click" ID="LinkButton1" CssClass="btn btn-success  float-right">Submit</asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
                            </div>
