<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/CscMasterPage.master" AutoEventWireup="true" CodeFile="MainCscBookingAndCancel.aspx.cs" Inherits="Auth_MainCscBookingAndCancel" %>
                    ...
                    <div class="card-header">
                        <div class="row ">
                            <div class="col-4">
                                ...
                                <asp:Label ID="Label3" runat="server" ForeColor="Green" Font-Size="small" Font-Bold="false" Text="(Details Available Only 15 Days at a time)"></asp:Label>

                            </div>
                            <div class="col-2">
                                <asp:Label ID="Label8" runat="server" Font-Size="small" Font-Bold="false" Text="Sub CSC"></asp:Label><br />
                                <asp:DropDownList ID="ddlagent" CssClass="form-control form-control-sm" runat="server" AutoPostBack="true"></asp:DropDownList>
                            </div>
                            <div class="col-2">
