...
public partial class Auth_PassAdminmaster : System.Web.UI.MasterPage
{
    ...
    private void checkForSecurity()
    {
        ...
        if (_security.isSessionExist(Session["_RNDIDENTIFIERPADM"]) == true)
        {
            Session["_RNDIDENTIFIERPADM"] = Session["_RNDIDENTIFIERPADM"];
        }
        else
        {
            Response.Redirect("sessionTimeout.aspx");
