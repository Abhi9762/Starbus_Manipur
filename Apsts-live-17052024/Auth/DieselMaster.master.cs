...
public partial class DieselMaster : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack == false)
        {
			lblModuleName.Text = "Diesel Fill Entry";
    ...
    private void checkForSecurity()
    {
        ...
        if (_security.isSessionExist(Session["_RNDIDENTIFIERDIESEL"]) == true)
        {
            Session["_RNDIDENTIFIERDIESEL"] = Session["_RNDIDENTIFIERDIESEL"];
        }
        else
        {
            Response.Redirect("../sessionTimeout.aspx");
