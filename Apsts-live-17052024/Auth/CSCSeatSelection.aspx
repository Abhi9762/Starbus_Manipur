<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/subCscMaster.master" AutoEventWireup="true" CodeFile="CSCSeatSelection.aspx.cs" Inherits="Auth_CSCSeatSelection" %>
            ...
            $(".available, .woman, .man, .sleeper, .selected").click(function () {
                ...
                if (className == "selected") {
                    ...
                    if (selectedSeat < PassangerNo) {
                        ...
                        $testHtml = "<tr class='row mb-2 seat-entry tr" + rowClass + "'><td class='col-md-2 col-6 cus-seat-no pl-4'><blink><span class='csn' style='font-size: 15px; font-weight: bold;'>" + seatNoCat[0] + "</span></blink></td><td class='col-md-3 col-6'><input class='Name' placeholder='Min 2 & Max 25 ' autocomplete='off' style='width:100%; height: 29px; border-radius: 3px; font-size: 12px;' type='text' Id='d1' maxlength='25' /></td><td class='col-md-2 col-6'>" + selectGender + "</td><td class='col-md-2 col-6'><input class='Age pl-1' placeholder='Age' onkeypress='return onlyNumberKey(event)' autocomplete='off' style='width:100%;  height: 29px; border-radius: 3px; font-size: 12px;' type='text' Id='tbAge" + idCount.toString() + "' maxlength='2' /></td><td class='col-md-3 col-6'>" + selectCategory + "</td></tr>";
