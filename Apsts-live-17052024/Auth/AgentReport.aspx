                        ...
                        <div class="card-body" style="padding: 5px 10px; min-height: 70vh;">
                            ...
                            <asp:GridView ID="gvAccountsmryreport" runat="server" GridLines="None" CssClass="table table-responsive" AllowPaging="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Trans.<br> Date">
                                        <ItemTemplate>
                                            <%# Eval("trans_date", "{0:dd/MM/yyyy}") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Open.<br> Balance<br> (A)">
                                        <ItemTemplate>
                                            <%#Eval("opening_balance") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Top Up<br> Amount<br> (B)">
                                        <ItemTemplate>
                                            <%#Eval("deposit_amount") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Canc.<br> Amount<br> (C)">
                                        <ItemTemplate>
                                            <%#Eval("dbticket_amt") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Trans.<br> Amount<br> (D)">
                                        <ItemTemplate>
                                            <%#Eval("transaction_amount") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Comm.<br> Amount">
                                        <ItemTemplate>
                                            <%#Eval("comm_amt") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Closing<br> Balance<br> (A+B+C)-D">
                                        <ItemTemplate>
                        ...
                        <div class="card-body" style="padding: 5px 10px; min-height: 70vh;">
                            ...
                            <asp:GridView ID="gvTransactionreport" runat="server" GridLines="None" CssClass="table table-responsive" AllowPaging="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Action<br> Type">
                                        <ItemTemplate>
                                            <%#Eval("val_action") %>                                          
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Trans.<br> Amount">
                                        <ItemTemplate>
                                            <%#Eval("val_TOTALAMT") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Ref.<br> Amount">
                                        <ItemTemplate>
