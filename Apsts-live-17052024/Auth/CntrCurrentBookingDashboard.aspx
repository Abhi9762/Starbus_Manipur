<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Cntrmaster.master" AutoEventWireup="true" CodeFile="CntrCurrentBookingDashboard.aspx.cs" Inherits="Auth_CntrCurrentBookingDashboard" %>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-1">
                                    <div class="col-12 text-center">
                                        <asp:LinkButton ID="lbtnnewtrip" runat="server" OnClick="lbtnnewtrip_Click" 
                                            CssClass="btn btn-success w-75 text-lg" OnClientClick="return ShowLoading()"><i class="fa fa-bus"></i> Start New Trip</asp:LinkButton>
                                                                ...
                                                                <div class="row mt-2">
                                                                    <div class="col-md-7 pr-0">
                                                                        <asp:LinkButton ID="lbtnCloseTrip" runat="server" CommandName="CloseTrip" CommandArgument='<%# Eval("trip_id") %>'
                                                                            ...
                                                                            ToolTip="Close Trip" OnClientClick="return ShowLoading()"> Generate Trip Chart</asp:LinkButton>
                                                                    </div>
                                                                    <div class="col-md-5 pl-0 text-right">
                                                                        <asp:LinkButton ID="lbtnBookTrip" runat="server" Visible="false" CommandName="OpenTrip"
                                                                            ...
                                                                            Style="border-radius: 4px; padding: 4px 10px;" ToolTip="Book More Tickets" OnClientClick="return ShowLoading()"> Book Ticket </asp:LinkButton>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-5">
                            <div class="card-body input-group-prepend">
                                ...
                                <asp:LinkButton runat="server" CssClass="btn btn-warning ml-1 btn-sm" ToolTip="Download Excel"><i class="fa fa-download"></i></asp:LinkButton>
                            </div>
                        </div>
                        <div class="col-12">
                            <hr />
