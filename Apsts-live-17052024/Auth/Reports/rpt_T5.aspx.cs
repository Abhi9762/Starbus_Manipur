...
public partial class Auth_Reports_rpt_T5 : BasePage
{
    ...
    string rpt = System.Web.HttpContext.Current.Server.MapPath("~/Auth/Reports/rpt_T5.rpt");

    protected void Page_Load(object sender, EventArgs e)
    {
        checkForSecurity();
        Session["_moduleName"] = "Counter Wise Report";
        if (!IsPostBack)
        {
            loadDEPOT();
    ...
    private void loadDEPOT()
    {
        try
        {
            ...
            ddlcounter.Items.Insert(0, "All");
            ddlcounter.Items[0].Value = "0";
        ...
        catch (Exception ex)
        {
            ...
            _common.ErrorLog("rpt_T5.aspx-001", ex.Message.ToString());
    ...
    private void loadReport(string rolecode, string _rptype)
    {
        ...
        catch (Exception ex)
        {
            ...
            ddlReport.Items[0].Value = "0";
            ddlReport.SelectedIndex = 0;
            _common.ErrorLog("rpt_T5.aspx-002", ex.Message.ToString());
        }
    ...
    private void loadReportType(string rolecode)
    {
        ...
        catch (Exception ex)
        {
            ...
            ddlReport.Items[0].Value = "0";
            ddlReport.SelectedIndex = 0;
            _common.ErrorLog("rpt_T5.aspx-003", ex.Message.ToString());
        }
    ...
    public DataTable LoadGrid()
    {
        try
        {
            NpgsqlCommand MyCommand = new NpgsqlCommand();
            MyCommand.Parameters.Clear();
            MyCommand.Parameters.AddWithValue("@StoredProcedure", "reports.f_get_rpt_t5");
            MyCommand.Parameters.AddWithValue("p_from_date", txtfromdate.Text);
            MyCommand.Parameters.AddWithValue("p_to_date", txttodate.Text);
            MyCommand.Parameters.AddWithValue("p_depot_code", ddldepot.SelectedValue);
        ...
        catch (Exception ex)
        {
            ...
            _common.ErrorLog("rpt_T5.aspx-004", ex.Message.ToString());
            return null;
        }
    }
    ...
    private void downloadReport()
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                cryrpt.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Context.Response, true, "Counter Wise Report" + DateTime.Now.ToString() + DateTime.Now); ;
            }
            else
                errorMassage("No Record Found");
        }
        ...
        {
            errorMassage("Something went wrong. Please contact to tech team.");
            _common.ErrorLog("rpt_T5.aspx-005", ex.Message.ToString());
        }
    }
    ...
    private bool IsValidValue()
    {
        ...
        {
            _common.ErrorLog("rpt_T5.aspx-006", ex.Message.ToString());
            return false;
    ...
    private void ExportGridToExcel()
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Counter Wise Report -" + DateTime.Now.ToString() + ".xls");
        Response.Charset = "";
        ...
        {
            _common.ErrorLog("rpt_T5.aspx-007", ex.Message.ToString());
    ...
    private void Test()
    {
        ...
        {
            _common.ErrorLog("rpt_T5.aspx-008", ex.Message.ToString());
