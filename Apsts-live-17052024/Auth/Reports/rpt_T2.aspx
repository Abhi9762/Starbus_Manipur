<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_T2.aspx.cs" Inherits="Auth_Reports_rpt_T2" %>
                ...
                <div class="card">
                    <div class="row card-header m-0 p-1">
                        <div class="col-lg-3">
                           ...
                           <div class="col-lg-3">
                            <div class="row">
                                <div class="col-lg-6 form-group" id="Canceldate" runat="server" visible="false">
                                    
                                  <label>Cancellation Date</label>
                                <div class="input-group date">
                                            <asp:TextBox ID="txtcanceldate" ToolTip="Enter Invoice Date" runat="server" CssClass="form-control form-control-sm" MaxLength="10" placeholder="DD/MM/YYYY" autocomplete="off"></asp:TextBox>
                         ...
                         <div class="col-lg-3">
                            <div class="row">
                                 ...
                                 <div class="col-lg-6 form-group">
                                  ...
                                  <div class="col-lg-6 form-group">
                                    <label id="lblcancellationmode" runat="server" visible ="false"  >
                                       Cancellation  Mode</label>
                                     <asp:DropDownList ID="ddlcancellationmode" runat="server" Visible="false" CssClass="form-control">
                                               <asp:ListItem runat="server" Value="0" Text="All"></asp:ListItem>
                                        <asp:ListItem runat="server" Value="T" Text="Online"></asp:ListItem>
                                        <asp:ListItem runat="server" Value="A" Text="Agent"></asp:ListItem>
                                        <asp:ListItem runat="server" Value="C" Text="Counter"></asp:ListItem>
                                        <asp:ListItem runat="server" Value="S" Text="Special Cancellation"></asp:ListItem>
                                        <asp:ListItem runat="server" Value="D" Text="Cancel Double Verification"></asp:ListItem>
                     	...
                     	<div class="card-body table-responsive" style="min-height: 320px;">
							<asp:GridView ID="gvOnlineBooking" runat="server" GridLines="None" CssClass="table" AllowPaging="true"  OnPageIndexChanging="gvOnlineBooking_PageIndexChanging"
								...
								<Columns>
                                    ...
                                    <asp:TemplateField HeaderText="CANCELLATION MODE">
										<ItemTemplate>
										 <%#Eval("cancellationmode") %>
										</ItemTemplate>
									</asp:TemplateField>
                                    <asp:TemplateField HeaderText="REFUND MODE">
										<ItemTemplate>
										 <%#Eval("refundmode") %>
										</ItemTemplate>
									</asp:TemplateField>
