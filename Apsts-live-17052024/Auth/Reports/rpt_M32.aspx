<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M32.aspx.cs" Inherits="Auth_Reports_rpt_M32" %>
                ...
                <div class="col-sm-12 flex-column d-flex stretch-card">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive" style="min-height: 320px;">
                            <asp:GridView ID="gvConcessionType" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"
                                AutoGenerateColumns="false" OnRowDataBound="gvConcessionType_RowDataBound" >
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Applicable Bus Pass">
                                        <ItemTemplate>
                                            <%#Eval("applicable_buspass") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Restricted Age">
                                      ...
                                      <asp:TemplateField HeaderText="Allowed Service">
                                        <ItemTemplate>
                                            <%#Eval("service_type") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                      ...
                                      <asp:TemplateField HeaderText="Additional Attendent">
                                        <ItemTemplate>
                                            <%#Eval("val_attendent") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
