...
public partial class Auth_Reports_rpt_T4 : BasePage
{
    ...
    string rpt = System.Web.HttpContext.Current.Server.MapPath("~/Auth/Reports/rpt_T4.rpt");

    protected void Page_Load(object sender, EventArgs e)
    {
        checkForSecurity();
        Session["_moduleName"] = "Daily Income Summary";
        if (!IsPostBack)
        {
    ...
    private void loadReport(string rolecode, string _rptype)
    {
        ...
        catch (Exception ex)
        {
            ...
            ddlReport.Items[0].Value = "0";
            ddlReport.SelectedIndex = 0;
            _common.ErrorLog("rpt_T4.aspx-001", ex.Message.ToString());
        }
    ...
    private void loadReportType(string rolecode)
    {
        ...
        catch (Exception ex)
        {
            ...
            ddlReport.Items[0].Value = "0";
            ddlReport.SelectedIndex = 0;
            _common.ErrorLog("rpt_T4.aspx-002", ex.Message.ToString());
        }
    ...
    public DataTable LoadGrid()
    {
        try
        {
            NpgsqlCommand MyCommand = new NpgsqlCommand();
            MyCommand.Parameters.Clear();
            MyCommand.Parameters.AddWithValue("@StoredProcedure", "reports.f_get_rpt_t4");
            ...
            if (dt.Rows.Count > 0)
            {
                lblsmry.Text = "Total Record <b> " + dt.Rows.Count.ToString() + " </b>" + " | Total Booking Amount <b>" + dt.Rows[0]["tot_booking_amt"].ToString() + " ₹ </b>" + " | Total Cancellation Amount <b>" + dt.Rows[0]["cancellation_amt"].ToString() + " ₹ </b>" + " | Total Amount <b>" + dt.Rows[0]["tot_amt"].ToString() + " ₹ </b>";
        ...
        {
            _common.ErrorLog("rpt_T4.aspx-003", ex.Message.ToString());
            return null;
        }
    }
    ...
    private void downloadReport()
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                cryrpt.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Context.Response, true, "Daily Income Summary" + DateTime.Now.ToString() + DateTime.Now); ;
            }
            else
                errorMassage("No Record Found");
        }
        ...
        {
            _common.ErrorLog("rpt_T4.aspx-004", ex.Message.ToString());
        }
    }
    ...
    private void Test()
    {
        ...
        {
            _common.ErrorLog("rpt_T4.aspx-005", ex.Message.ToString());
    ...
    private bool IsValidValue()
    {
        ...
        {
            _common.ErrorLog("rpt_T4.aspx-006", ex.Message.ToString());
            return false;
    ...
    private void ExportGridToExcel()
    {
        ...
        {
            _common.ErrorLog("rpt_T4.aspx-007", ex.Message.ToString());
