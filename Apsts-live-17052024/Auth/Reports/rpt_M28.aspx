<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M28.aspx.cs" Inherits="Auth_Reports_rpt_M28" %>
                ...
                <div class="card">
                    <div class="row card-header m-0 p-1">
                        ...
                        <div class="col-lg-4">
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    <asp:Label runat="server" ID="lblActive" Visible="false" Text="Active"></asp:Label>
                                    <asp:DropDownList ID="ddlActive" runat="server" Visible="false" CssClass=" form-control form-control-sm">
                                ...
                                <div class="card-body table-responsive" style="min-height: 320px;">
                                    <asp:GridView ID="gvItem" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Group Abbr">
                                                <ItemTemplate>
                                                    <%#Eval("group_abbr") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
