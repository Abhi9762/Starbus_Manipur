<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/cntrMasterPage.master" AutoEventWireup="true" CodeFile="rpt_CA2.aspx.cs" Inherits="Auth_Reports_rpt_CA2" %>
                        ...
                        <asp:GridView ID="gvOnlineBooking" runat="server" CssClass="table text-left table-striped" GridLines="None"
							...
							<Columns>
                                ...
                                <asp:TemplateField HeaderText="TRANSACTION DATE">
                                    ...
                                    <asp:TemplateField HeaderText="ONLINE BOOKING AMOUNT">
										<ItemTemplate>
									   <%#Eval("online_booking_amount") %>
										</ItemTemplate>
									</asp:TemplateField>
								<asp:TemplateField HeaderText="CURRENT BOOKING AMOUNT">
										<ItemTemplate>
										 <%#Eval("current_booking_amount") %>
										</ItemTemplate>
									</asp:TemplateField>
