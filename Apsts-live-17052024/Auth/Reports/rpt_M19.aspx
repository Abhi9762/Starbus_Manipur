<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M19.aspx.cs" Inherits="Auth_Reports_rpt_M19" %>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="card-body table-responsive" style="min-height: 320px;">
                                    ...
                                    <asp:GridView ID="gvothercharge" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"
                                   ...
                                   <ItemTemplate>
									...
									<asp:TemplateField  HeaderText="Fare Type">
										...
										<ItemTemplate>
											...
											<asp:TemplateField  HeaderText="Charges (Rs.)">
										<ItemTemplate>
											<%#Eval("chargeamt") %>
										</ItemTemplate>
									</asp:TemplateField>
