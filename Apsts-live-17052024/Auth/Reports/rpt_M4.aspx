<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M4.aspx.cs" Inherits="Auth_Reports_rpt_M4" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 form-group">
                                    <label id="lbloffice" for="ddlofficelevel" runat="server" visible="false">
                                        Office</label>
                                    <asp:DropDownList ID="ddloffice" runat="server"   Visible="false" CssClass="form-control form-control-sm">
                                    </asp:DropDownList>
                                </div>
