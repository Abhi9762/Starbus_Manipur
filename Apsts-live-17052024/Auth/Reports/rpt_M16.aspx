<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M16.aspx.cs" Inherits="Auth_Reports_rpt_M16" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 form-group">
                                    <label id="lblstate" runat="server" visible="false" for="ddlState">
                                        State</label>
                                    <asp:DropDownList ID="ddlState" runat="server" Visible="false" AutoPostBack="true" CssClass="form-control form-control-sm">
                                    </asp:DropDownList>
                                </div>
                                ...
                                <div class="card-body table-responsive" style="min-height: 320px;">
                                    ...
                                    <asp:GridView ID="gvfare" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Rate Hills (Rs.)">
                                                <ItemTemplate>
                                                    <%#Eval("ratehill") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Rate Plain(Rs.)">
                                                <ItemTemplate>
                                                    <%#Eval("rateplain") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
