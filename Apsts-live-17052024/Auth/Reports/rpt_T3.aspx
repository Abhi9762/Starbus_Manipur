<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_T3.aspx.cs" Inherits="Auth_Reports_rpt_T3" %>
                     	...
                     	<div class="card-body table-responsive" style="min-height: 320px;">
							<asp:GridView ID="gvOnlineBooking" runat="server" GridLines="None" CssClass="table" AllowPaging="true"  OnPageIndexChanging="gvOnlineBooking_PageIndexChanging"
								...
								<Columns>
									...
									<asp:TemplateField HeaderText="BOOKING MODE">
										<ItemTemplate>
									   <%#Eval("bookingmodename") %>
										</ItemTemplate>
									</asp:TemplateField>
