<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M9.aspx.cs" Inherits="Auth_Reports_rpt_M9" %>
                ...
                <div class="col-sm-12 flex-column d-flex stretch-card">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive" style="min-height: 320px;">
                            <asp:GridView ID="gvUserRoles" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="Center" HeaderText="Role Name">
                                        <ItemTemplate>
                                            <%#Eval("role_name") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
