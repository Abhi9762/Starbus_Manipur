<%@ Page Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_P7.aspx.cs" Inherits="Auth_Reports_rpt_P7" %>
                         ...
                         <div class="input-group date">
                                 ...
                                 <div class="col-lg-2 form-group">
                                    <label id="lblpayment" runat="server" visible ="false"  >
                                     ...
                                     <asp:DropDownList ID="ddlpayment"  runat="server" Visible="false" CssClass="form-control form-control-sm">
                                                </asp:DropDownList>
                                </div>
                ...
                <div class="col-sm-12 flex-column d-flex stretch-card">
                    <div class="card">
                     	...
                     	<div class="card-body table-responsive" style="min-height: 320px;">
							<asp:GridView ID="gvRefund" runat="server" GridLines="None" CssClass="table" AllowPaging="true"  OnPageIndexChanging="gvRefund_PageIndexChanging"
								PageSize="15" AutoGenerateColumns="false">
								 <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Refund DateTime">
                                        <ItemTemplate>
                                            <%#Eval("refunddate") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Refund Amount">
                                        <ItemTemplate>
                                            <%#Eval("refundamount") %> <i class="fa fa-rupee-sign"></i>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Refund Reference No.">
                                        <ItemTemplate>
                                            <%#Eval("refundrefno") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>                                  
