<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M20.aspx.cs" Inherits="Auth_Reports_rpt_M20" %>
	...
	<div class="container-fluid" style="padding-top: 20px;">
					...
					<div class="row card-header m-0 p-1">
						<div class="col-lg-12">
							...
							<div class="col-lg-2 form-group">
										...
										<div class="col-lg-2 form-group">
											<label id="lblroute" runat="server" visible="false"  for="ddlroute">
												Route Name</label>
        ...
        <asp:Panel runat="server" ID="pnlReport" Visible="false">
					<div class="row">
						...
						<asp:GridView ID="gvdepot" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"  
								AutoGenerateColumns="false" OnRowDataBound="gvdepot_RowDataBound">
								<Columns>
                                   ...
                                   <ItemTemplate>
									...
									<asp:TemplateField HeaderText="Departure Time">
										...
										<ItemTemplate>
											...
											<asp:TemplateField HeaderText="Service Days">
										<ItemTemplate>
											<%#Eval("servicedurationdays") %>
										</ItemTemplate>
									</asp:TemplateField>
                           ...
                           <h5 class="mt-2 mb-0">Summary</h5>
                                ...
                                <div class="row">
                                 ...
                                 <b><asp:Label ID="lbltotaldepot" runat="server" Text=""></asp:Label></b>
                                    </div>
