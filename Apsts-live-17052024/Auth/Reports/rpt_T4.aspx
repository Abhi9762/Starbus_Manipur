<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_T4.aspx.cs" Inherits="Auth_Reports_rpt_T4" %>
                            ...
                            <asp:GridView ID="gvOnlineBooking" runat="server" GridLines="None" CssClass="table" AllowPaging="true" OnPageIndexChanging="gvOnlineBooking_PageIndexChanging"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="BOOKING AMOUNT">
                                        <ItemTemplate>
                                            <%#Eval("val_booking_amount") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="CANCELLATION AMOUNT">
                                        <ItemTemplate>
                                            <%#Eval("val_cancellation_amount") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
