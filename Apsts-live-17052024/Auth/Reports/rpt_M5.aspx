<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M5.aspx.cs" Inherits="Auth_Reports_rpt_M5" %>
                    ...
                    <div class="row card-header m-0 p-1">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-lg-2 form-group">
                                    <asp:Label runat="server" ID="lblCategory" Visible="false" Text="Layout Category"></asp:Label>
                                    <asp:DropDownList ID="ddlCategory" runat="server"  Visible="false" CssClass="form-control form-control-sm">
                                        <asp:ListItem Value="0">All</asp:ListItem>
                                        <asp:ListItem Value="G">General</asp:ListItem>
                                        <asp:ListItem Value="S">Sleeper</asp:ListItem>
                                ...
                                <div class="col-lg-2 form-group">
                                    ...
                                    <asp:DropDownList ID="ddlstatus" runat="server" Visible="False" CssClass="form-control form-control-sm">
                                        <asp:ListItem runat="server" Value="E" Text="Draft"></asp:ListItem>
                                        <asp:ListItem runat="server" Value="L" Text="Locked"></asp:ListItem>

                                    </asp:DropDownList>
                                </div>
                                <div class="col-lg-1 form-group pt-3 mt-2">
                                    <asp:LinkButton ID="lbtnSearch" runat="server" OnClientClick="return ShowLoading()"  OnClick="lbtnSearch_Click" Visible="false" CssClass="btn btn-warning btn-sm">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                ...
                                <div class="card-body table-responsive" style="min-height: 320px;">
                                    <asp:GridView ID="gvBusLayout" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Layout Name">
                                                <ItemTemplate>
                                                    <%#Eval("layoutname") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Layout Category">
                                                <ItemTemplate>
                                                    <%#Eval("val_layout_category") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Seat(s) for Booking">
                                                <ItemTemplate>
                                                    <%#Eval("total_seats_for_booking") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Total Seat(s)">
                                                <ItemTemplate>
                                                    <%#Eval("totalseats") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                            ...
                            <div class="col-sm-2">
                                ...
                                <div class="row">
                                 ...
                                 <b>
                                     <asp:Label ID="lbltotalbuslayout" runat="server" Text=""></asp:Label></b>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6" style="border-right: 2px solid #eee">
                                        ...
                                        <br />
                                        <b>
                                            <asp:Label ID="lblLockedSearch" runat="server" Text=""></asp:Label></b>
                                    </div>
                                    <div class="col-sm-6" style="border-right: 2px solid #eee">
                                        Draft
                                            <br />
                                        <b>
                                            <asp:Label ID="lblDraftSearch" runat="server" Text=""></asp:Label></b>
                                    </div>
                                </div>
                            </div>
                        </div>
