<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M15.aspx.cs" Inherits="Auth_Reports_rpt_M15" %>
                    ...
                    <div class="row card-header m-0 p-1">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-lg-2 form-group">
                                    <label id="lblroute" for="ddlroute" visible="false" runat="server">
                                        Route Name</label>
                                    <asp:DropDownList ID="ddlroute"   runat="server" Visible="false" CssClass="form-control form-control-sm">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-lg-2 form-group">
                                ...
                                <div class="col-sm-1 pt-3 mt-2">
                                    <asp:LinkButton ID="lbtnSearch"   runat="server" OnClientClick="return ShowLoading()" Visible="false" CssClass="btn btn-warning btn-sm" OnClick="lbtnSearch_Click">
                        ...
                        <div class="row">
                                    ...
                                    <asp:GridView ID="gvroute" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="From Station">
                                                <ItemTemplate>
                                                    <%#Eval("fromstationname") %> (<%#Eval("fromstatename")%>)
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="To Station">
                                                <ItemTemplate>
                                                    <%#Eval("tostationname") %> (<%#Eval("tostatename")%>)
                                                </ItemTemplate>
                                            </asp:TemplateField>
                            ...
                            <div class="col-sm-2">
                                ...
                                <div class="row">
                                 ...
                                 <b>
                                     <asp:Label ID="lblTotalstation" runat="server" Text=""></asp:Label></b>
                                    </div>
