<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M2.aspx.cs" Inherits="Auth_Reports_rpt_M2" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 form-group">
                                    ...
                                    <label id="lblstate" runat="server" visible="false" for="ddlState">
                                        State</label>
                                    <asp:DropDownList ID="ddlState"  runat="server" Visible="false" AutoPostBack="true" OnClientClick="return ShowLoading()" CssClass="form-control form-control-sm" OnSelectedIndexChanged="ddlState_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-lg-2 form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-10" style="border-right: 2px solid #eee">
                            ...
                            <div class="card-body table-responsive" style="min-height: 320px;">
                                  <asp:GridView ID="gvcity" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"
                                        AutoGenerateColumns="false" OnRowDataBound="gvcity_RowDataBound">
                                        <Columns>
                   ...
                   <div class="col-sm-2">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        Total  :                                  
                                                              <b>
                                                                  <asp:Label ID="lblcitiescount" runat="server" Text=""></asp:Label></b>
                                    </div>
                                </div>
                                <div class="row">
