<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_TC2.aspx.cs" Inherits="Auth_Reports_rpt_TC2" %>
                                ...
                                <div class="row" id="dvperameter" runat="server" visible="false">
                                    ...
                                    <div class="col-lg-2">
                                        <label for="ddlcounter">
                                            Booking Agent</label>
                                        <asp:DropDownList ID="ddlagent" OnClientClick="return ShowLoading()" runat="server" AutoPostBack="true" CssClass="form-control form-control-sm">
                                        </asp:DropDownList>
                                    </div>
