<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M7.aspx.cs" Inherits="Auth_Reports_rpt_M7" %>
                    ...
                    <div class="row card-header m-0 p-1">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-lg-2 form-group">
                                    <label id="lblstatus" visible="false"  runat="server" for="ddlstatus">
                                        Status</label>
                                    <asp:DropDownList ID="ddlstatus" Visible="false"  runat="server" CssClass="form-control form-control-sm">
                        ...
                        <div class="row">
                            <div class="col-sm-10" style="border-right: 2px solid #eee">
                                ...
                                <div class="card-body table-responsive" style="min-height: 320px;">
                                    <asp:GridView ID="gvAgencies" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Email Id">
                                                <ItemTemplate>
                                                    <span style="text-transform:lowercase;"><%#Eval("val_email") %></span>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Contact Person Details">
                                                <ItemTemplate>
                                                    <%#Eval("contact_name") %>
                                                    <br />
                                                    <i class="fa fa-envelope mr-1"></i>
                                                    <span style="text-transform:lowercase;"><%#Eval("contact_email") %></span>
                                                    
                                                    <br />
                                                    <i class="fa fa-mobile mr-1"></i><%#Eval("contact_mobile") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                            ...
                            <div class="col-sm-2">
                                ...
                                <div class="row">
                                 ...
                                 <b>
                                     <asp:Label ID="lbltotalagencies" runat="server" Text=""></asp:Label></b>
                                    </div>
