<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M24.aspx.cs" Inherits="Auth_Reports_rpt_M24" %>
                ...
                <div class="col-sm-12 flex-column d-flex stretch-card">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive" style="min-height: 320px;">
                            <asp:GridView ID="gvFillingStation" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"
                                AutoGenerateColumns="false" OnRowDataBound="gvFillingStation_RowDataBound">
                                <Columns>
