<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M10.aspx.cs" Inherits="Auth_Reports_rpt_M10" %>
                    ...
                    <div class="row card-header m-0 p-1">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-lg-2 form-group">
                                    <asp:Label runat="server" ID="lblServiceType" Visible="false" Text="Service Type"></asp:Label>

                                    <asp:DropDownList ID="ddlStripId" runat="server"  Visible="false" CssClass="form-control form-control-sm">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-lg-2 form-group">
                                    <asp:Label runat="server" ID="lblDepo" Visible="false" Text="Depot"></asp:Label>
                                    <asp:DropDownList ID="ddlDepo" runat="server"  Visible="false" CssClass=" form-control form-control-sm">
                                    </asp:DropDownList>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                ...
                                <div class="card-body table-responsive" style="min-height: 320px;">
                                    <asp:GridView ID="gvBus" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"
                                        AutoGenerateColumns="false" OnRowDataBound="gvBus_RowDataBound">
                                        <Columns>
                            ...
                            <div class="col-sm-2">
                                ...
                                <div class="row">
                                 ...
                                 <b>
                                     <asp:Label ID="lbltotalbus" runat="server" Text=""></asp:Label></b>
                                    </div>
