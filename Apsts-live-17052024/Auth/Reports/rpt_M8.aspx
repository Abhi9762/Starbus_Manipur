<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M8.aspx.cs" Inherits="Auth_Reports_rpt_M8" %>
                    ...
                    <div class="row card-header m-0 p-1">
                        <div class="col-lg-12">
                            <div class="row">
                             ...
                             <div class="col-lg-2 form-group">
                                    <label id="lblstatus" runat="server"  for="ddlstatus">
                                        Status</label>
                                    <asp:DropDownList ID="ddlstatus" runat="server" CssClass="form-control form-control-sm">
                                        <asp:ListItem runat="server" Value="Y" Text="Active"></asp:ListItem>
                                        <asp:ListItem runat="server" Value="N" Text="Discontinue"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                ...
                <div class="col-sm-12 flex-column d-flex stretch-card">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive" style="min-height: 320px;">
                            <asp:GridView ID="gvDesignation" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="Center" HeaderText="Designation Name">
                                        <ItemTemplate>
                           ...
                           <h5 class="mt-2 mb-0">Summary</h5>
                                ...
                                <div class="row">
                                 ...
                                 <b><asp:Label ID="lbltotaldesignation" runat="server" Text=""></asp:Label></b>
                                    </div>
