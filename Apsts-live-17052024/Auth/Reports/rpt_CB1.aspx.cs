...
public partial class Auth_Reports_rpt_CB1 : BasePage
{
    ...
    string rpt = System.Web.HttpContext.Current.Server.MapPath("rpt_CB1.rpt");
    ...
    private void loadReport(string rolecode, string _rptype)
    {
        ...
        catch (Exception ex)
        {
            ...
            ddlReport.Items[0].Value = "0";
            ddlReport.SelectedIndex = 0;
            _common.ErrorLog("rpt_CB1.aspx-0001", ex.Message);
        }
    ...
    private void loadReportType(string rolecode)
    {
        ...
        catch (Exception ex)
        {
            ...
            ddlReport.Items[0].Value = "0";
            ddlReport.SelectedIndex = 0;
            _common.ErrorLog("rpt_CB1.aspx-0002", ex.Message);
    ...
    private void LoadGrid()
    {
        try
        {
            NpgsqlCommand MyCommand = new NpgsqlCommand();
            MyCommand.Parameters.Clear();
            MyCommand.Parameters.AddWithValue("@StoredProcedure", "counter_reports.f_get_cntr_online_ticket");
            MyCommand.Parameters.AddWithValue("p_counter_id", Session["_UserCntrID"].ToString());
            MyCommand.Parameters.AddWithValue("p_booking_date", txtBookingdate.Text);
        ...
        catch (Exception ex)
        {
            ...
            pnlReport.Visible = false;
            Errormsg("No Record is available");
            _common.ErrorLog("rpt_CB1.aspx-0003", ex.Message);
        }
    }
    private void downloadReport()
    {
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                cryrpt.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Context.Response, true, "Daily Online Booking Report-" + DateTime.Now.ToString() + DateTime.Now);
