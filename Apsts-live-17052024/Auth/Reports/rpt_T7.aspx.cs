...
public partial class Auth_Reports_rpt_T7 : BasePage
{
    ...
    string rpt = System.Web.HttpContext.Current.Server.MapPath("~/Auth/Reports/rpt_T7.rpt");

    protected void Page_Load(object sender, EventArgs e)
    {
        checkForSecurity();
        Session["_moduleName"] = "Counter Daily Account Report";
        if (!IsPostBack)
        {
    ...
    private void loadReport(string rolecode, string _rptype)
    {
        ...
        catch (Exception ex)
        {
            ...
            ddlReport.Items[0].Value = "0";
            ddlReport.SelectedIndex = 0;
            _common.ErrorLog("rpt_T7.aspx-001", ex.Message.ToString());
        }
    ...
    private void loadReportType(string rolecode)
    {
        ...
        catch (Exception ex)
        {
            ...
            ddlReport.Items[0].Value = "0";
            ddlReport.SelectedIndex = 0;
            _common.ErrorLog("rpt_T7.aspx-002", ex.Message.ToString());
        }
    ...
    public DataTable LoadGrid()
    {
        try
        {
            NpgsqlCommand MyCommand = new NpgsqlCommand();
            MyCommand.Parameters.Clear();
            MyCommand.Parameters.AddWithValue("@StoredProcedure", "reports.f_get_rpt_t7");
            MyCommand.Parameters.AddWithValue("p_from_date", txtfromdate.Text);
            MyCommand.Parameters.AddWithValue("p_to_date", txttodate.Text);
            MyCommand.Parameters.AddWithValue("p_counter", ddlcounter.SelectedValue);
            ...
            if (dt.Rows.Count > 0)
            {
                lblsmry.Text = "Total Record <b> " + dt.Rows.Count.ToString() + " </b>" + " | Online Booking Amount <b>" + dt.Rows[0]["online_booking_amt"].ToString() + " ₹ </b>" + " | Current Booking Amount <b>" + dt.Rows[0]["current_booking_amt"].ToString() + " ₹ </b>" + " | Pass Amount <b>" + dt.Rows[0]["pass_amt"].ToString() + " ₹ </b>" + " | Cancellation Amount <b>" + dt.Rows[0]["cancellation_amt"].ToString() + " ₹ </b>";
        ...
        catch (Exception ex)
        {
            ...
            _common.ErrorLog("rpt_T7.aspx-003", ex.Message.ToString());
            return null;
        }
    }
    ...
    private void downloadReport()
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                objtxtRPTCounter.Text = ddlcounter.SelectedItem.Text;
                ...
                cryrpt.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Context.Response, true, "Counter Daily Account Report-" + DateTime.Now.ToString() + DateTime.Now); ;
            }
            else
                errorMassage("No Record Found");
        }
        ...
        {
            errorMassage("Something went wrong. Please contact to tech team.");
            _common.ErrorLog("rpt_T7.aspx-004", ex.Message.ToString());
        }
    }
    ...
    private void Test()
    {
        ...
        {
            _common.ErrorLog("rpt_T7.aspx-005", ex.Message.ToString());
    ...
    private bool IsValidValue()
    {
        ...
        {
            _common.ErrorLog("rpt_T7.aspx-006", ex.Message.ToString());
            return false;
    ...
    private void ExportGridToExcel()
    {
        ...
        {
            _common.ErrorLog("rpt_T7.aspx-007", ex.Message.ToString());
