<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M13.aspx.cs" Inherits="Auth_Reports_rpt_M13" %>
                        ...
                        <div class="row">
                            <div class="col-sm-12" style="border-right: 2px solid #eee">
                                ...
                                <div class="card-body table-responsive" style="min-height: 320px;">
                                    <asp:GridView ID="gvdistance" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"
                                        AutoGenerateColumns="false" OnRowDataBound="gvdistance_RowDataBound">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="From Station ">
                                                <ItemTemplate>
                                                    <%#Eval("from_station_name") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="To Station">
                                                <ItemTemplate>
                                                    <%#Eval("to_station_name") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Halt Time">
                                                <ItemTemplate>
                                                    <%#Eval("halttimemin") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Toll (Single)">
                                                <ItemTemplate>
                                                    <%#Eval("tollchargesingle") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Toll (Double)">
                                                <ItemTemplate>
                                                    <%#Eval("tollchargedouble") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Parking (Single)">
                                                <ItemTemplate>
                                                    <%#Eval("parkingchargesingle") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Parking (double)">
                                                <ItemTemplate>
                                                    <%#Eval("parkingchargedouble") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
