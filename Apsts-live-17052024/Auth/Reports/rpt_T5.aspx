<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_T5.aspx.cs" Inherits="Auth_Reports_rpt_T5" %>
                            ...
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    <label for="ddlReportType">
                                        Report Type</label>
                                    <asp:DropDownList ID="ddlReportType" runat="server" AutoPostBack="true" CssClass="form-control form-control-sm" OnSelectedIndexChanged="ddlReportType_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-lg-6 form-group">
                                    <label for="ddlReport">
                           ...
                           <div class="col-lg-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 pt-3 mt-2">
                                    <asp:LinkButton ID="lbtnsearch" runat="server"  visible ="false" Onclick="lbtnSearch_Click" CssClass ="btn btn-warning btn-sm">
						...
						<asp:GridView ID="gvOnlineBooking" runat="server" GridLines="None" CssClass="table" AllowPaging="true"  OnPageIndexChanging="gvOnlineBooking_PageIndexChanging"
								...
								<Columns>
                                    ...
                                    <asp:TemplateField HeaderText="TRANSACTION DATE">
										<ItemTemplate>
									   <%#Eval("bookingdatetime") %>
										</ItemTemplate>
									</asp:TemplateField>
									<asp:TemplateField HeaderText="COUNTER">
										<ItemTemplate>
									   <%#Eval("bookedbyusercode") %>
										</ItemTemplate>
									</asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="NO. OF CANCELLATIONS">
										<ItemTemplate>
										 <%#Eval("cancelseats") %>
										</ItemTemplate>
									</asp:TemplateField>
