...
public partial class Auth_Reports_rpt_T8 : BasePage
{
    ...
    string rpt = System.Web.HttpContext.Current.Server.MapPath("~/Auth/Reports/rpt_T8.rpt");

    protected void Page_Load(object sender, EventArgs e)
    {
        checkForSecurity();
        Session["_moduleName"] = "Agent Daily Account Report";
        if (!IsPostBack)
        {
    ...
    private void loadReport(string rolecode, string _rptype)
    {
        ...
        catch (Exception ex)
        {
            ...
            ddlReport.Items[0].Value = "0";
            ddlReport.SelectedIndex = 0;
            _common.ErrorLog("rpt_T8.aspx-001", ex.Message.ToString());
        }
    ...
    private void loadReportType(string rolecode)
    {
        ...
        catch (Exception ex)
        {
            ...
            ddlReport.Items[0].Value = "0";
            ddlReport.SelectedIndex = 0;
            _common.ErrorLog("rpt_T8.aspx-002", ex.Message.ToString());
        }
    ...
    public DataTable loadGrid()
    {
        try
        {
            NpgsqlCommand MyCommand = new NpgsqlCommand();
            MyCommand.Parameters.Clear();
            MyCommand.Parameters.AddWithValue("@StoredProcedure", "reports.f_get_rpt_t8");
            ...
            if (dt.Rows.Count > 0)
            {
                lblsmry.Text = "Total Record <b> " + dt.Rows.Count.ToString() + " </b>" + " | Deposited Amount <b>" + dt.Rows[0]["depositamt_"].ToString() + " ₹ </b>" + " | Online Booking Amount <b>" + dt.Rows[0]["Online_booking_amt"].ToString() + " ₹ </b>" + " | Current Booking Amount <b>" + dt.Rows[0]["Currnt_booking_amt"].ToString() + " ₹ </b>" + " | Pass Amount <b>" + dt.Rows[0]["pass_amt"].ToString() + " ₹ </b>" + " | Cancellation Amount <b>" + dt.Rows[0]["cancellation_amt"].ToString() + " ₹ </b>" + " | Commission Amount <b>" + dt.Rows[0]["concession_amt"].ToString() + " ₹ </b>";
        ...
        catch (Exception ex)
        {
            ...
            _common.ErrorLog("rpt_T8.aspx-003", ex.Message.ToString());
            return null;
        }
    }
    ...
    private void downloadReport()
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                cryrpt.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Context.Response, true, "Agent Daily Account Report-" + DateTime.Now.ToString() + DateTime.Now); ;
            }
            else
                errorMassage("No Record Found");
        }
    ...
    private bool IsValidValue()
    {
        ...
        {
            _common.ErrorLog("rpt_T8.aspx-005", ex.Message.ToString());
    ...
    private void ExportGridToExcel()
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Agent Daily Account Report -" + DateTime.Now.ToString() + ".xls");
            Response.Charset = "";
        ...
        {
            _common.ErrorLog("rpt_T8.aspx-006", ex.Message.ToString());
    ...
    private void Test()
    {
        ...
        {
            _common.ErrorLog("rpt_T8.aspx-007", ex.Message.ToString());
