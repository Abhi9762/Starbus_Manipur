<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M34.aspx.cs" Inherits="Auth_Reports_rpt_M34" %>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="card-body table-responsive" style="min-height: 320px;">
                                    <asp:GridView ID="gvSms" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="Center" HeaderText="Purpose">
                                                <ItemTemplate>
                                                    <%#Eval("val_purpose") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="Center" HeaderText="Sms Format">
                                                <ItemTemplate>
                                                    <%#Eval("smsformat") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="Center" HeaderText=" DLT.Template ID">
                                                <ItemTemplate>
                                                    <%#Eval("templatename") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
