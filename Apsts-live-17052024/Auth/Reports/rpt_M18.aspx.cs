...
public partial class Auth_Reports_rpt_M18 : BasePage
{
    ...
    {
        checkForSecurity();
        Session["_moduleName"] = "State Service wise Tax Reports";
        if (!IsPostBack)
        {
    ...
    private void loadState()
    {
        ...
        catch (Exception ex)
        {
            ...
            ddlState.Items[0].Value = "0";
            ddlState.SelectedIndex = 0;
            _common.ErrorLog("rpt_M18.aspx-001", ex.Message.ToString());
        }
    }
    private void loadServiceType()
    {
        ...
        catch (Exception ex)
        {
            ...
            ddlService.Items[0].Value = "0";
            ddlService.SelectedIndex = 0;
            _common.ErrorLog("rpt_M18.aspx-002", ex.Message.ToString());
        }
    ...
    private void loadReport(string rolecode, string _rptype)
    {
        ...
        catch (Exception ex)
        {
            ...
            ddlReport.Items[0].Value = "0";
            ddlReport.SelectedIndex = 0;
            _common.ErrorLog("rpt_M18.aspx-003", ex.Message.ToString());
        }
    ...
    private void loadReportType(string rolecode)
    {
        ...
        catch (Exception ex)
        {
            ...
            ddlReport.Items[0].Value = "0";
            ddlReport.SelectedIndex = 0;
            _common.ErrorLog("rpt_M18.aspx-004", ex.Message.ToString());
        }
    ...
    public void loadGrid()
    {
        try
        {
            NpgsqlCommand MyCommand = new NpgsqlCommand();
            MyCommand.Parameters.Clear();
            MyCommand.Parameters.AddWithValue("@StoredProcedure", "reports.f_get_rpt_m18");
        ...
        {
            _common.ErrorLog("rpt_M18.aspx-005", ex.Message.ToString());
        }
    }
    private void Test()
    {
        ...
        {
            _common.ErrorLog("rpt_M18.aspx-006", ex.Message.ToString());
        }
    }
