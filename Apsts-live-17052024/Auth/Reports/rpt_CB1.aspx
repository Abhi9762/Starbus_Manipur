<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/cntrMasterPage.master" AutoEventWireup="true" CodeFile="rpt_CB1.aspx.cs" Inherits="Auth_Reports_rpt_CB1" %>
                    	   ...
                    	   <asp:GridView ID="gvOnlineBooking" runat="server" CssClass="table text-left table-striped" GridLines="None"
							...
							<Columns>
                                ...
                                <asp:TemplateField HeaderText="TICKET NO.">
									   ...
									   <%#Eval("ticketno") %>
                                            <br />
                                       <span class="text-muted">STATUS -</span> <%#Eval("currentstatus") %>
										</ItemTemplate>
									</asp:TemplateField>
