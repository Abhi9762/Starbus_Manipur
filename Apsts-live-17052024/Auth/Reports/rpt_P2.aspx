<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_P2.aspx.cs" Inherits="Auth_Reports_rpt_P2" %>
                ...
                <div class="col-sm-12 flex-column d-flex stretch-card">
                    <div class="card">
                     	...
                     	<div class="card-body table-responsive" style="min-height: 320px;">
							<asp:GridView ID="gvPaymentGatewaySummary" runat="server" GridLines="None" CssClass="table" AllowPaging="true"  OnPageIndexChanging="gvPaymentGatewaySummary_PageIndexChanging"
								...
								<Columns>
									...
									<asp:TemplateField HeaderText="CREDITED AMOUNT">
										<ItemTemplate>
										 <%#Eval("creditedamount") %>
										</ItemTemplate>
									</asp:TemplateField>
									<asp:TemplateField HeaderText="DEBITED AMOUNT">
										<ItemTemplate>
										 <%#Eval("debitedamount") %>
										</ItemTemplate>
									</asp:TemplateField>
