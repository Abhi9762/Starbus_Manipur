<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M3.aspx.cs" Inherits="Auth_Reports_rpt_M3" %>
                    ...
                    <div class="row card-header m-0 p-1">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-lg-2 form-group">
                                    <label id="lbloffice" for="ddlofficelevel" runat="server"  visible="false">
                                        Office Level</label>
                                    <asp:DropDownList ID="ddlofficelevel" runat="server"  Visible="false" CssClass="form-control form-control-sm">
                                    </asp:DropDownList>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-10" style="border-right: 2px solid #eee">
                                ...
                                <div class="card-body table-responsive" style="min-height: 320px;">
                                    ...
                                    <asp:GridView ID="gvoffice" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"
                                        AutoGenerateColumns="false" OnRowDataBound="gvoffice_RowDataBound">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Reporting Office">
                                                <ItemTemplate>
                                                    <%#Eval("val_reportingofficename") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                            ...
                            <div class="col-sm-2">
                                <asp:Label runat="server" CssClass="mt-2 mb-0" Font-Size="Large" Font-Bold="true">Summary</asp:Label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        HQ :
                                            ...
                                            <asp:Label ID="lblHqCount" runat="server" Text=""></asp:Label>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                       Division :
                                            ...
                                            <asp:Label ID="lblDivisionCount" runat="server" Text=""></asp:Label>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        Depot :
                                            ...
                                            <asp:Label ID="lblDepotCount" runat="server" Text=""></asp:Label>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        SSI :
                                            ...
                                            <asp:Label ID="lblSsiCount" runat="server" Text=""></asp:Label>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        Workshop :
                                            ...
                                            <asp:Label ID="lblWorkshopCount" runat="server" Text=""></asp:Label>
                                    </div>
