...
public partial class Auth_Reports_rpt_M33 : BasePage
{
    ...
    private void loadReport(string rolecode, string _rptype)
    {
        ...
        catch (Exception ex)
        {
            ...
            ddlReport.Items[0].Value = "0";
            ddlReport.SelectedIndex = 0;
            _common.ErrorLog("rpt_M33.aspx-001", ex.Message.ToString());
        }
    ...
    private void loadReportType(string rolecode)
    {
        ...
        catch (Exception ex)
        {
            ...
            ddlReport.Items[0].Value = "0";
            ddlReport.SelectedIndex = 0;
            _common.ErrorLog("rpt_M33.aspx-002", ex.Message.ToString());
        }
    ...
    public void loadGrid()
    {
        try
        {
            NpgsqlCommand MyCommand = new NpgsqlCommand();
            MyCommand.Parameters.Clear();
            MyCommand.Parameters.AddWithValue("@StoredProcedure", "reports.f_get_rpt_m33");
            DataTable dt = new DataTable();
            dt = bll.SelectAll(MyCommand);
            if (dt.Rows.Count > 0)
            {
        ...
        {
            _common.ErrorLog("rpt_M33.aspx-003", ex.Message.ToString());
        }
    }
    private void Test()
    {
        ...
        {
            _common.ErrorLog("rpt_M33.aspx-004", ex.Message.ToString());
        }
    }
    #endregion 
