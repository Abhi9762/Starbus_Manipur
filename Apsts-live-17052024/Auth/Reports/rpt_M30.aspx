<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M30.aspx.cs" Inherits="Auth_Reports_rpt_M30" %>
                ...
                <div class="card">
                    <div class="row card-header m-0 p-1">
                        ...
                        <div class="col-lg-4">
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    <asp:Label runat="server" ID="lblAgType" Visible="false" Text="Agent Type"></asp:Label>
                                    <asp:DropDownList ID="ddlAgent" runat="server" Visible="false" CssClass="form-control form-control-sm">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-lg-6 form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-10" style="border-right: 2px solid #eee">
                                ...
                                <div class="card-body table-responsive" style="min-height: 320px;">
                                    <asp:GridView ID="gvAgents" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"
                            ...
                            <div class="col-sm-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <b>
                                            <asp:Label ID="lblRegularSearch" runat="server" Text=""></asp:Label></b>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <b>
                                            <asp:Label ID="lblThirdPartySearch" runat="server" Text=""></asp:Label></b>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <b>
                                            <asp:Label ID="lblCscSearch" runat="server" Text=""></asp:Label></b>
                                    </div>
