<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M29.aspx.cs" Inherits="Auth_Reports_rpt_M29" %>
                    ...
                    <div class="row card-header m-0 p-1">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-lg-3 form-group">
                                    <asp:Label runat="server" ID="lblofclvl" Visible="false" Text="Office Level"></asp:Label>

                                    <asp:DropDownList ID="ddlOfclvl" AutoPostBack="true" OnSelectedIndexChanged="ddlOfclvl_SelectedIndexChanged" OnClientClick="return ShowLoading()" runat="server" Visible="false" CssClass=" form-control form-control-sm">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-lg-3 form-group">
                                    <asp:Label runat="server" ID="lblofc" Visible="false" Text="Office"></asp:Label>
                                    <asp:DropDownList ID="ddlofc" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlofc_SelectedIndexChanged" OnClientClick="return ShowLoading()" Visible="false" CssClass=" form-control form-control-sm">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-lg-3 form-group">
                                    <asp:Label runat="server" ID="lblPostingOfc" Visible="false" Text="Posting Office"></asp:Label>
                                    <asp:DropDownList ID="ddlpostingOFC" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlpostingOFC_SelectedIndexChanged" OnClientClick="return ShowLoading()" Visible="false" CssClass=" form-control form-control-sm">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-lg-3 form-group">
                                    <asp:Label runat="server" ID="lbldesignation" Visible="false" Text="Designation"></asp:Label>
                                    <asp:DropDownList ID="ddldesignation" runat="server" Visible="false" CssClass="form-control form-control-sm">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-lg-3 form-group">
                                ...
                                <div class="col-lg-3 form-group pt-3 mt-2">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                ...
                                <div class="card-body table-responsive" style="min-height: 320px;">
                                    <asp:GridView ID="gvEmployee" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Designation">
                                                <ItemTemplate>
                                                    <%#Eval("emp_designationname") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Mobile No.">
                                                <ItemTemplate>
                                                    <%#Eval("emp_mobilenumber") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                            ...
                            <div class="col-sm-2">
                                ...
                                <div class="row">
                                 ...
                                 <b>
                                     <asp:Label ID="lbltotalemployee" runat="server" Text=""></asp:Label></b>
                                    </div>
