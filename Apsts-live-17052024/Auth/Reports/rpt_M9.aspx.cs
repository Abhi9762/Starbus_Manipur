...
public partial class Auth_Reports_rpt_M9 : BasePage
{
    ...
    {
        checkForSecurity();
        Session["_moduleName"] = "User Role Report";
        if (!IsPostBack)
        {
    ...
    private void loadReport(string rolecode, string _rptype)
    {
        ...
        catch (Exception ex)
        {
            ...
            ddlReport.Items[0].Value = "0";
            ddlReport.SelectedIndex = 0;
            _common.ErrorLog("rpt_M9.aspx-001", ex.Message.ToString());
        }
    ...
    private void loadReportType(string rolecode)
    {
        ...
        catch (Exception ex)
        {
            ...
            ddlReport.Items[0].Value = "0";
            ddlReport.SelectedIndex = 0;
            _common.ErrorLog("rpt_M9.aspx-002", ex.Message.ToString());
        }
    ...
    private void loadUserRoles()
    {
        try
        {
            NpgsqlCommand MyCommand = new NpgsqlCommand();
            MyCommand.Parameters.Clear();
            MyCommand.Parameters.AddWithValue("@StoredProcedure", "reports.f_get_rpt_m9");
        ...
        {
            _common.ErrorLog("rpt_M9.aspx-003", ex.Message.ToString());
        }
    }
    private void Test()
    {
        ...
        try
        {
            ...
            {
                gvUserRoles.UseAccessibleHeader = true;
                gvUserRoles.HeaderRow.TableSection = TableRowSection.TableHeader;
            }
        }

        catch (Exception ex)
        {
            _common.ErrorLog("rpt_M9.aspx-004", ex.Message.ToString());
        }
    }
