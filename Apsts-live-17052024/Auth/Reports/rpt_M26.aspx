<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M26.aspx.cs" Inherits="Auth_Reports_rpt_M26" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 form-group">
                                    <label id="lbldepot" runat="server" visible="false" for="ddldepot">
                                        Depot</label>
                                    <asp:DropDownList ID="ddldepot" runat="server"  Visible="false" OnSelectedIndexChanged="ddldepot_SelectedIndexChanged" AutoPostBack="true" OnClientClick="return ShowLoading()" CssClass="form-control form-control-sm">
                                    </asp:DropDownList>
                                </div>

                                <div class="col-lg-2 form-group">
                                    <label id="lblstation" runat="server" visible="false" for="ddlfngstation">
                                        Filling Stations</label>
                                    <asp:DropDownList ID="ddlfngstation" Visible="false"  runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlfngstation_SelectedIndexChanged" OnClientClick="return ShowLoading()" CssClass="form-control form-control-sm">
                                    </asp:DropDownList>
                                </div>

                                <div class="col-lg-2 form-group">
                                    <label id="lbltank" runat="server" visible="false" for="ddltank">
                                        Tank</label>
                                    <asp:DropDownList ID="ddltank" runat="server"  Visible="false" CssClass="form-control form-control-sm">
                                    </asp:DropDownList>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="card-body table-responsive" style="min-height: 320px;">
                                    <asp:GridView ID="gvpump" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Pump No">
                                                <ItemTemplate>
                                                    <%#Eval("pump_number") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Initial Reading">
                                                <ItemTemplate>
                                                    <%#Eval("initial_reading") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
