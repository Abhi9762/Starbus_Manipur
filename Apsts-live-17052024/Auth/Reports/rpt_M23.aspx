<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M23.aspx.cs" Inherits="Auth_Reports_rpt_M23" %>
                ...
                <div class="card">
                    <div class="row card-header m-0 p-1">
                        ...
                        <div class="col-lg-4">
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    <asp:Label runat="server" ID="lblService" Visible="false" Text="Service Type"></asp:Label>

                                    <asp:DropDownList ID="ddlService" runat="server" Visible="false" CssClass=" form-control form-control-sm">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-lg-6 form-group">
                                    <asp:Label runat="server" ID="lblroute" Visible="false" Text="Route"></asp:Label>
                ...
                <div class="col-sm-12 flex-column d-flex stretch-card">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive" style="min-height: 320px;">
                            <asp:GridView ID="gvFci" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Seating Capacity">
                                        <ItemTemplate>
                                            <%#Eval("seating_capacity") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="FCI Amount">
                                        <ItemTemplate>
                                            <%#Eval("fci_amt") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
