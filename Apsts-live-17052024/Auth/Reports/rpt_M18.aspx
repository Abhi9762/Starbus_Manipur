<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/Reports/SysAdmReportmaster.master" AutoEventWireup="true" CodeFile="rpt_M18.aspx.cs" Inherits="Auth_Reports_rpt_M18" %>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="card-body table-responsive" style="min-height: 320px;">
                                    ...
                                    <asp:GridView ID="gvtax" runat="server" GridLines="None" CssClass="table" ClientIDMode="Static"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Tax Based on">
                                                <ItemTemplate>
                                                    <%#Eval("TAXBASEDONFLAG") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Tax Type (Hill/Plain)">
                                                <ItemTemplate>
                                                    <%#Eval("TAXTYPEFLAG") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
