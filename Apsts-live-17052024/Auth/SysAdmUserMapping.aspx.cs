...
public partial class Auth_SysAdmUserMapping : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            Session["_moduleName"] = "Module Mapping";
            ...
            LoadEmployee("10", "1000000000", "0");
            loadCountsmry("10", "1000000000");
    ...
    private void loadCountsmry(String OfcLv, String Ofc)
    {
        try
        {
            ...
            else
            {
                ...
                _common.ErrorLog("SysAdmUserMapping.aspx-0001", dt.TableName);
            }
        ...
        catch (Exception ex)
        {
            ...
            _common.ErrorLog("SysAdmUserMapping.aspx-0002", ex.Message.ToString());
        }
    }
    private void LoadEmployee(String OfcLv, String Ofc, String Postingofc)
    {
        try
        {
            ...
            else
            {
                ...
                _common.ErrorLog("SysAdmUserMapping.aspx-0003", dt.TableName);
            }
        ...
        {
            Errormsg("There is some error" + ex.Message);
            _common.ErrorLog("SysAdmUserMapping.aspx-0004", ex.Message.ToString());
        }
    }
    private void validuser(string empcode, string _ofcID, string _ofcLevelID)
    {
        try
        {
            ...
            if (dt.TableName == "Success")
            {
                ...
                {
                    grdemployee.Visible = false;
                    lblempname.Text = dt.Rows[0]["empname"] + "(" + dt.Rows[0]["e_empcode"] + ")";
        ...
        {
            Errormsg("There is some error" + ex.Message);
            _common.ErrorLog("SysAdmUserMapping.aspx-0005", ex.Message.ToString());
        }
    }
    private void getAssignedmodule(string _ofcLevelID, string _Userid)
    {
        ...
        {
            Errormsg("There is some error" + ex.Message);
            _common.ErrorLog("SysAdmUserMapping.aspx-0006", ex.Message.ToString());
        }
    }
    private void getmodule(string _ofcLevelID, string _Userid)
    {
        ...
        {
            Errormsg("There is some error" + ex.Message);
            _common.ErrorLog("SysAdmUserMapping.aspx-0007", ex.Message.ToString());
        }
    }
    private string checkmoduleassign(string moduleid)
    {
        ...
        {
            Errormsg("There is some error" + ex.Message);
            _common.ErrorLog("SysAdmUserMapping.aspx-0008", ex.Message.ToString());
            return "";
        }
    ...
    public void ExportGridToExcel()
    {
        ...
        MyCommand.Parameters.Clear();
        MyCommand.Parameters.AddWithValue("@StoredProcedure", "auth.f_get_module");
        MyCommand.Parameters.AddWithValue("p_ofclvlid", "10");
    ...
    private void LoadModuleAssignmentReport()
    {
        try
        {
            ...
            MyCommand.Parameters.AddWithValue("p_ofclvlid", 10);
            MyCommand.Parameters.AddWithValue("p_ofcid", "1000000000");
        ...
        catch (Exception ex)
        {
            ...
            _common.ErrorLog("SysAdmUserMapping.aspx-0009", ex.Message.ToString());
        }
    }
