...
public partial class Auth_tripchartdash : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Session["_RoleCode"].ToString() == "4")
            {
                ...
                ddldepot.SelectedValue = Session["_LDepotCode"].ToString();
                ddlcounter.SelectedValue = Session["_UserCntrID"].ToString();
            }
        ...
        try
        {
            ...
            if (dt.TableName == "Success")
            {
                if (dt.Rows.Count > 0)
                {
                    ...
                    ddlcounter.DataTextField = "titl";
                    ddlcounter.DataValueField = "counter_code";
                    ddlcounter.DataBind();
                }
            }
    ...
    private void loadReadyTrip()
    {
        try
        {
            ...
            DataTable dt = obj.gettrip(ddldepot.SelectedValue, ddlcounter.SelectedValue, "O", "A", txtdate.Text);
    ...
    private void loadUpcoming()
    {
        ...
        {
            wsClass obj = new wsClass();
            DataTable dt = obj.gettrip(ddldepot.SelectedValue, ddlcounter.SelectedValue, "O", "U", txtdate.Text);
            DataRow[] dtrow = dt.Select("minutes>=startminute and minutes <=endminute");
            if (dtrow.Length > 0)
            {
    ...
    private void loadPrepared()
    {
        ...
        {
            wsClass obj = new wsClass();
            DataTable dt = obj.gettrip(ddldepot.SelectedValue, ddlcounter.SelectedValue, "O", "P", txtdate.Text);
            DataRow[] dtrow = dt.Select("minutes>=startminute and minutes <=endminute");
            if (dtrow.Length > 0)
            {
    ...
    private void loadUnprepared()
    {
        ...
        {
            wsClass obj = new wsClass();
            DataTable dt = obj.gettrip(ddldepot.SelectedValue, ddlcounter.SelectedValue, "O", "T", txtdate.Text);
            DataRow[] dtrow = dt.Select("minutes>=startminute and minutes <=endminute");
            if (dtrow.Length > 0)
            {
