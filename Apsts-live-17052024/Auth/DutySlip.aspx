<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DutySlip.aspx.cs" Inherits="Auth_DutySlip" %>
...
<body>
    <form id="form1" runat="server">
        <div id="details" runat="server">
			...
			<%--<asp:Button ID="btnPrint" Style="border-radius: 10px; margin-top: 10px;margin-bottom:5px; background-color: aliceblue; font-size: 16px;"
            ...
            <div class=" row m-0" id="maindiv" style="width: 100%; border: 1px solid;">
                <div class="col-lg-12">
                        ...
                        <tr style="vertical-align: top;">
                            ...
                            <td style="vertical-align: middle;">
                                <center>
                                    ...
                                    <h3 style="font-size: 14pt">Duty Slip</h3>
                                </center>
                            </td>
                            <td>
                                <img alt="" runat="server" class="igte_rPayNet_ButtonImg" id="imgQRCode" style="border-width: 0px; width: 90px; border: 2px solid #eaf4ff;" />
                            </td>
                    ...
                    <table class="table table-borderless" style="margin: auto">
                        ...
                        <tr>
                            <td>
                                <asp:Label runat="server" CssClass="form-control-label" Font-Bold="true" Text="Duty Reference No"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td colspan="12" >
                                <asp:Label ID="lblBus" runat="server" Text="2. Bus Details" Font-Underline="true" Font-Size="Medium" CssClass="form-control-label ml--10"
                                    Font-Bold="true" class="text-center"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="4" >
                                <asp:Label ID="lblCrew" runat="server" Font-Underline="true" Font-Size="Medium" Text="3. Crew Details"
                                    Font-Bold="true" class="text-center"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="12" >
                                <asp:Label ID="Label2" runat="server" Text="4. Trip Details" Font-Underline="true" Font-Size="Medium" CssClass="form-control-label ml--10"
                                    Font-Bold="true"  class="text-center"></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <asp:GridView ID="gvServiceTrips" runat="server" Font-Size="9pt" AutoGenerateColumns="false" GridLines="None" CssClass="table table-bordered" DataKeyNames="STRP_ID,DSVC_ID">
                        <Columns>
                    ...
                    <table style="vertical-align: top">
                        <%--<tr>
                            <td>
                                <asp:Label runat="server" CssClass="form-control-label" Font-Bold="true" Text="Prepared By:"></asp:Label>

                            </td>
                            <td>
                                <asp:Label ID="lblJIName" runat="server" Text="" CssClass="form-control-label"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>(<asp:Label ID="lblJIDesig" runat="server" Text="" CssClass="form-control-label"></asp:Label>)</td>
                        </tr>
                        --%>
                        <tr>
                            <td><b><span>Prepared By:</span></b></td>
                            <td>
                                <asp:Label ID="lblJIName" runat="server" Font-Size="9pt" Text="" Font-Names="Verdana"></asp:Label>
                                (<asp:Label ID="lblJIDesignation" runat="server" Font-Size="9pt" Text="" Font-Names="Verdana"></asp:Label>)
                            </td>
                        </tr>
                        <tr>
                            <td><b><span>Duty Slip Date/Time:</span></b></td>
                            <td>
                                <asp:Label ID="lblprintdatetime" runat="server" Text="-" CssClass="form-control-label"></asp:Label></td>
                        </tr>
                    </table>
                    <br />
                    <br />
                    <center>
                        <asp:Label ID="lblHelpdeskdept" runat="server" Text="For any query please contact  helpdesk"
                             Font-Bold="true" ></asp:Label></center>
                    <br />
                </div>
                <center>
                    <asp:Label ID="msg" runat="server" Text="Sorry Something went wrong. please contact  helpdesk"
