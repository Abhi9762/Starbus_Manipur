                                ...
                                <br />
                                            ...
                                            <div class="card" style="min-height: 10vh; margin-bottom: 10px">
                                                <div class="card-body" style="padding: 10px; text-align: center; height: 80px">
                                                    ...
                                                    <div class="col-lg-12 p-0">
                                                        <asp:linkbutton ID="Label3" runat="server" CommandArgument="3" Text="0" CssClass="text-success" Font-Size="16pt" Font-Bold="true" CommandName="N"></asp:linkbutton>
                                                        <br />
                                                        <label for="ddhead" style="line-height: 18px;">
                                ...
                                <br />
                                            ...
                                            <div class="card" style="min-height: 10vh; margin-bottom: 10px">
                                                <div class="card-body" style="padding: 10px; text-align: center; height: 80px">
                                                    ...
                                                    <div class="col-lg-12 p-0">
                                                        <asp:linkbutton ID="Label4" runat="server" CommandArgument="3" Text="0" CssClass="text-success" Font-Size="16pt" Font-Bold="true" CommandName="N"></asp:linkbutton>
                                                        <br />
                                                        <label for="ddhead" style="line-height: 18px;">
                                                           Repaired & Issued
                                <br />
                                            ...
                                            <div class="card" style="min-height: 10vh; margin-bottom: 10px">
                                                <div class="card-body" style="padding: 10px; text-align: center; height: 80px">
                                                    ...
                                                    <div class="col-lg-12 p-0">
                                                        <asp:linkbutton ID="Label5" runat="server" CommandArgument="3" Text="0" CssClass="text-success" Font-Size="16pt" Font-Bold="true" CommandName="N"></asp:linkbutton>
                                                        <br />
                                                        <label for="ddhead" style="line-height: 18px;">
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="row mt-1">
                                        ...
                                        <div class="col-lg-3" runat="server" id="divIMEI1" visible="false">
                                            ...
                                            <asp:TextBox ID="tbIMEI1" MaxLength="15" autocomplete="off" placeholder="Max 15 Characters" CssClass="form-control form-control-sm text-uppercase" runat="server" ToolTip="IMEI No.1"></asp:TextBox>
                                        ...
                                        <div class="col-lg-3" runat="server" id="divIMEI2" visible="false">
                                            ...
                                            <asp:TextBox ID="tbIMEI2" MaxLength="15" autocomplete="off" placeholder="Max 15 Characters" CssClass="form-control form-control-sm text-uppercase" runat="server" ToolTip="IMEI No.2"></asp:TextBox>
                              ...
                              <%--  <h6 class="heading-small my-0 mt-2">4. Issuance Details</h6>
                                ...
                                <div class="pl-lg-4 mt-3 mb-2">
                                    ...
                                    <i class="fa fa-edit"></i>&nbsp; Update</asp:LinkButton>
                                            <asp:LinkButton ID="lbtnCancel"  Visible="false" runat="server" class="btn btn-danger" ToolTip="Save And Lock">
            ...
            <div class="row">
                <div class="col-12 mt-5">
                    <center>
                        ...
                        DataKeyNames="etmid , etmrefno , etmtype , etmmake , etmserialno, purchasemode , agencyid , imeino1 , imeino2 , receivingdate , receivedby , statuslogid , statustypeid ,rec_officename ,rec_office,issued_office, invoice_no , invoice_date , invoice_amount , invoice_doc , actionlogid , etmtypename , makemodel , agency , etmstatus ">
                        <Columns>
                         ...
                         <asp:TemplateField>
                                <ItemTemplate>
                                                ...
                                                <div class="col-auto text-right">
                                                    ...
                                                    <asp:LinkButton ID="lbtntransferETM" Visible="true" runat="server" CommandName="TransferETM" CssClass="btn btn-sm btn-primary" CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' Style="border-radius: 4px;" title="Transfer ETM" data-toggle="tooltip" data-placement="bottom">T</asp:LinkButton>
                ...
                <div class="card" style="width: 400px; height: 200px">
                        ...
                        <div class="col-lg-12" style="font-size: 11pt;">
                         ...
                         <br />
                               ...
                               <div class="row" runat="server" >
                                   <div class="col-lg-12">
                                       <label>ETM Branch</label>
                                       <br />
                                        <asp:DropDownList ID="ddlETMBranch"  runat="server"  CssClass="form-control form-control-sm" ToolTip="ETM Branch">
                                            </asp:DropDownList>
                                   </div>
        ...
        <asp:Panel ID="pnlviewetm" runat="server" Style="position: fixed; display: none">
                    ...
                    <div class="card" style="min-height:600px;width:1200px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                               <h6 class="heading-small  my-0"> Log Details</h6>
                            </div>
                            </div>
