<%@ Page Language="C#" AutoEventWireup="true" CodeFile="home.aspx.cs" Inherits="homee" MaintainScrollPositionOnPostback="true" %>
...
<head runat="server">
    ...
    <meta name="description" content="Starbus MSTS online ticket booking service of Manipur State Transport Services, Govt of Manipur" />
    <meta name="author" content="Starbus* Manipur" />
    <meta name="keywords" content="Starbus msts, MSTS, Manipur State Transport Services, Book Ticket ,Cancel Ticket , Govt of Manipur , Online Bus Services, Seatavailablity, Bus Pass, Agent booking, Common service Center Booking" />

    <title>StarBus* 1.0</title>
    <!-- Favicon -->
...
<body id="top">
    <form id="form1" runat="server">
        ...
        <main>
            <nav class="navbar navbar-expand-lg" style="background: #021952; max-height: 100vh;">
                <div class="container">
                    <a class="navbar-brand" href="#" style="line-height: 10px; color: white;">
                        <table>
                            <tr>
                                <td>
                                    <asp:Image runat="server" ID="ImgDepartmentLogo" Height="40px"  ImageUrl="" />
                                </td>
                                <td style="padding-left: 5px;">
                                    <asp:Label runat="server" ID="lblDeptName" CssClass="deptName" Text="" Font-Size="15px"> </asp:Label>
                                    <br />
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-lg-5 me-lg-auto">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" id="navbarAboutUs" role="button" data-bs-toggle="dropdown" aria-expanded="false">About Us</a>
                                <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarAboutUs">
                                    ...
                                    <hr />
                                    <li runat="server" id="lblagents"><a class="dropdown-item" href="Agents.aspx" title="Click here to authorized agents">
                                    ...
                                    <li runat="server" id="lblcsccentres"><a class="dropdown-item" href="CommonServiceCentres.aspx" title="Click here to Common Service Centers">
                                    ...
                                    <li runat="server" id="lblparcelbooking"><a class="dropdown-item" href="CourierBooking.aspx" title="Click here for Parcel Booking">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" id="navbarAnyQuery" role="button" data-bs-toggle="dropdown" aria-expanded="false">Any Query</a>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" id="navbarOnlineServices" role="button" data-bs-toggle="dropdown" aria-expanded="false">Online Services</a>
                                <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                    ...
                                    <div runat="server" id="divbuspass">
                                        <hr />
                        ...
                        <div class="d-none d-lg-block dropdown" id="navvv">
                    ...
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navvvv" aria-controls="navvvv" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="navbar-icon bi-person"></span>
                    </button>

                    <div class="d-lg-none d-xl-none collapse" id="navvvv" style="width: 100%; text-align: right;">
                        <ul class="navbar-nav ms-lg-5 me-lg-auto pt-2">
                            <li class="nav-item"><a class="nav-link click-scroll" href="traveller/trvlLogin.aspx">Traveller Login</a></li>
                            <li class="nav-item"><a class="nav-link click-scroll" href="Login.aspx">Department Login</a></li>
                        </ul>
                    </div>
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <p class="text-center mb-0">
                                                    Welcome to MSTS Online Services
                                            ...
                                            <table class="w-100">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a runat="server" id="lblbuspassahref" href="BusPass.aspx" class="text-white mb-1"><i class="fa fa-angle-double-right small-tx" aria-hidden="true"></i>&nbsp; Bus  Passes</a><br />
                                                    </td>
                                                </tr>
                                            </table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <p class="mb-0 text-white" style="font-size: 16px;">
                                                            ...
                                                            <asp:Label ID="lblNoconductormsg" runat="server" Text=""></asp:Label>
                                                        </p>
            ...
            <section class="explore-section section-padding" id="dvmentor" runat="server">
        ...
        <footer class="site-footer section-padding"
            style="background-image: linear-gradient(rgb(53 71 126), rgba(0, 28, 108, 0.9)), url(assets/img/footer-bg.jpg); background-size: cover; padding: 60px 0px; border-top: 5px solid #f3941e;">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <h6 class="site-footer-title mb-3" style="color: #b3b3b3 !important;">Useful Link<br />
                            <div class="mt-2" style="height: 2px; width: 60px; background: #f3941e;">
                            </div>
                        </h6>
                    ...
                    <div class="col-lg-3 col-md-4 col-6 mb-4 mb-lg-0">
                        <h6 class="site-footer-title mb-3" style="color: #b3b3b3 !important;">Contact Info<br />
                            <div class="mt-2" style="height: 2px; width: 60px; background: #f3941e;">
                            </div>
                        </h6>
                    ...
                    <div class="col-lg-3 col-md-4 col-12 mt-4 mt-lg-0 ms-auto">
                        <h6 class="site-footer-title mb-3" style="color: #b3b3b3 !important;">Powered By<br />
                            <div class="mt-2" style="height: 2px; width: 60px; background: #f3941e;">
                            </div>
                        </h6>
                    ...
                    <div class="modal-body">
                        <ul class="list-group" style="">
                            <li class="list-group-item">Cancellation/Refund/Rescheduling Ticket booked through Online,
                                    ...
                                    to the Bank procedure. No refund will be done at MSTS ticket booking counters
                            ...
                            <li class="list-group-item">Reservation Fee is non-refundable except in case of 100%
                                    cancellation of tickets, if the service is cancelled by MSTS for operational or any
                                    other reasons.</li>
                            ...
                            <li class="list-group-item">Passengers will be given normally in one month, after the
                                    ...
                                    month, passengers may contact helpline .</li>
            ...
            <div class="card">
                ...
                <div class="card-body overflow-auto" style="min-width: 35vw !important; max-width: 95vw !important; min-height: 20vh; max-height: 80vh;">
                    ...
                    <div class="w-100 text-center p-3 pb-4">
                        <h1 class="text-center">StarBus* MSTS Traveller Mobile App is also available.</h1>
                    </div>
                    <div class="row">
                        <div class="col text-center">
                            <%-- <asp:LinkButton ID="lbtndownload" runat="server" OnClick="appdownload_ServerClick" class="btn btn-primary btn-sm" Style="font-size: 12pt; color: white;">
                                 <i class="fa fa-mobile"></i> Download App </asp:LinkButton>--%>

                            <asp:LinkButton ID="lbtndownload1" Visible="false" runat="server" OnClick="appdownload_ServerClick" class="btn btn-primary btn-sm" Style="font-size: 12pt; color: white;">
 <i class="fa fa-mobile"></i> Download App </asp:LinkButton>
                            <a id="lbtndownload" href="https://play.google.com/store/apps/details?id=com.MSTSonline.MSTSbooking&pcampaignid=web_share" target="_blank" class="w-100 btn btn-primary btn-sm">
