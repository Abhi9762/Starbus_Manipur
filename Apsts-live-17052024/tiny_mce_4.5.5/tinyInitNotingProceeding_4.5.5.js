...
{	
	...
	tinymce.init({
		mode : "exact",
		elements: "ctl00$ContentPlaceHolder1$tbProceedingPara",
		//elements: "noting",
		language :"en",
	        ...
	        fullscreen_settings : {
				...
				setup : function(ed)
				{
					ed.on('init', function()
						...
						this.execCommand("fontSize", false, customsize);
							});    		 
...
function getCustomContentStyle()
{
	...
	return " body,td,pre {font-size:" + customsize + ";} pre{ white-space:pre-wrap;white-space: -moz-pre-wrap;white-space: -pre-wrap;white-space: -o-pre-wrap;word-wrap: break-word;} .document_class { font-size:" + customsize +"; font-family:Times New Roman;width: 160mm; min-height: 297mm;  padding: 8px 16px 16px;margin: 8px auto; border-radius: 5px; background: white; overflow-wrap:break-word; word-wrap:break-word; overflow:scroll}html { background-color: lightgrey;} table {margin: 0px;} .document_class ul {margin: 0px;}"
}
