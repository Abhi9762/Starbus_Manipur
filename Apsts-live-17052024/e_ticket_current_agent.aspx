<%@ Page Language="C#" AutoEventWireup="true" CodeFile="e_ticket_current_agent.aspx.cs" Inherits="e_ticket_current_agent" %>
        ...
        <asp:Panel ID="pnldetails" runat="server" Visible="false">
            ...
            <div class="watermark" id="maindiv" style="width: 275px; text-align: center; border: 1px solid; font-size: 12pt;">
                <table id="divprint">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblcommission" runat="server" Text="NA" CssClass="centered"></asp:Label>
                        </td>
