...
public partial class E_ticket_current : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (dt.TableName == "Success")
            {
                if (dt.Rows.Count > 0)
                {
                    ...
                    lbltotfare.Text = "Total Fare (" + dt.Rows[0]["total_seatsbooked"].ToString() + "*" + dt.Rows[0]["amountfare"].ToString() + ") - <b>₹ " + dt.Rows[0]["amounttotal"].ToString() + "</b>";
                    ...
                    lblbookedby.Text = "Booked By " + dt.Rows[0]["book_by"].ToString();
